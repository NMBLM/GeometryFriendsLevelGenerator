...
namespace FarseerGames.FarseerPhysics.Dynamics {
    public class FixedRevoluteJoint : Joint {
        ...
        {
            FixedRevoluteJoint clone = new FixedRevoluteJoint(
            ...
            clone.localAnchor = this.localAnchor;
            clone.r1 = this.r1;
            ...
            if (this.Tag != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cloning fixed revolution joint with non value-type tag. Not cloning the tag property.");
                }
            }
            return clone;
        }
