...
namespace FarseerGames.FarseerPhysics.Dynamics {
    public class RevoluteJoint : Joint {
        ...
        public override Joint Clone(Dictionary<int, Body> oldToNewBodyMappings)
        {
            ...
            clone.localAnchor1 = this.localAnchor1;
            clone.localAnchor2 = this.localAnchor2;
            clone.r1 = this.r1;
            clone.r2 = this.r2;
            clone.velocityBias = this.velocityBias;
            clone.accumulatedImpulse = this.accumulatedImpulse;
            clone.currentAnchor = this.currentAnchor;
            ...
            if (this.Tag != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cloning revolute joint with non value-type tag. Not cloning the tag property.");
                }
            }
            return clone;
        }
