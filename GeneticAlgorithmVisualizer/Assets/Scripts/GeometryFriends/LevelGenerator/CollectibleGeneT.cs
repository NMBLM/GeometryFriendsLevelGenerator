...
namespace GeometryFriends.LevelGenerator
{
    ...
    public class CollectibleGeneT : GeneT
    {
        public Point position;
        
        //Random Constructor
        public CollectibleGeneT(Random random)
        {
        ...
        //Copy Constructor
        public CollectibleGeneT(CollectibleGeneT other)
        {
            type = GeneType.Collectible;
        ...
        public CollectibleGeneT( Point position)
        {
            type = GeneType.Collectible;
