...
namespace FarseerGames.FarseerPhysics.Dynamics {
    public class AngleLimitJoint : Joint {
        ...
        {
            AngleLimitJoint clone = new AngleLimitJoint(
            ...
            if (this.Tag != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cloning angle limit joint with non value-type tag. Not cloning the tag property.");
                }
            }
            return clone;
        }
