...
namespace FarseerGames.FarseerPhysics.Dynamics {
    public class FixedLinearSpring : Controller {
        ...
        {
            FixedLinearSpring clone = new FixedLinearSpring(
            ...
            if (this.Tag != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cloning fixed linear spring with non value-type tag. Not cloning the tag property.");
                }
            }
