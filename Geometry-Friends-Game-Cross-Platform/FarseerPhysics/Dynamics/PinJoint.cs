...
namespace FarseerGames.FarseerPhysics.Dynamics {
    public class PinJoint : Joint {
        ...
        public override Joint Clone(Dictionary<int, Body> oldToNewBodyMappings)
        {
            ...
            //ensure proper clone
            clone.targetDistance = this.targetDistance;
            ...
            clone.worldAnchor1 = this.worldAnchor1;
            clone.worldAnchor2 = this.worldAnchor2;
            clone.r1 = this.r1;
            clone.r2 = this.r2;
            clone.velocityBias = this.velocityBias;
            clone.accumulatedImpulse = this.accumulatedImpulse;
            clone.worldAnchorDifferenceNormalized = this.worldAnchorDifferenceNormalized;
            clone.effectiveMass = this.effectiveMass;
            ...
            if (this.Tag != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cloning pin joint with non value-type tag. Not cloning the tag property.");
                }
            }
            return clone;
        }
